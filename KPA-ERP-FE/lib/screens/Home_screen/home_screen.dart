...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadFormData() async {
    ...
    if (mounted) {
      setState(() {
        formNumberController.text = prefs.getString('formNumber') ?? '';
        inspectionByController.text = prefs.getString('inspectionBy') ?? '';
        inspectionDateController.text = prefs.getString('inspectionDate') ?? '';
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.pushNamed(context, Routes.wheelSpecForm).then((_) {
                if (mounted) {
                  setState(() {});
                  _loadFormData();
                }
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              Navigator.pushNamed(context, Routes.bogieChecksheetForm).then((_) {
                if (mounted) {
                  setState(() {});
                  _loadFormData();
                }
          ...
          //
          // --- FIX: Added the new ListTile for viewing submitted forms ---
          //
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              // This will now correctly navigate to your new screen
              Navigator.pushNamed(context, Routes.submittedForms).then((_) {
                if (mounted) {
                  // Refresh the home screen when you return, just in case
                  setState(() {});
                }
              });
            },
