...
class AuthService {
  ...
  static Future<String> logout(
    ...
    try {
      ...
      //
      // THE FIX IS HERE: Use the named parameter 'data:'
      //
      final response = await ApiService.delete('/api/users/logout/', data: request);
      return response["message"] ?? "Logout successful.";
    } on ApiException catch (e) {
      throw (e.message);
    } catch (e) {
      return "Error Occurred while Logout";
    }
  }
  ...
  static Future<String> verifyDeactivationOTP(
